...
def searchForStaff():
    ...
    email =input("Enter the Email address of the staff member you want to search for: ")
...
def editStudent():
    ...
    email =input("Enter the Email address of the staff member to edit: ")
    ...
    for contact in root.findall('contact'):
        ...
        if emailb==email:
            ...
            ntree.write("Staff.xml")            
            
            print("--------------------------------------------")
            print("STAFF RECORD ID: "+ id + " UPDATED")            
            print("--------------------------------------------")
